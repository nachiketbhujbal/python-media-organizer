...
| 0.6.5 | Pre-authorized unattended mode | Add a deliberately explicit non-interactive policy that may cross only enumerated, pre-authorized checkpoints and stops on every unexpected finding, changed state, failed proof, or unrecognized decision. | Release candidate |
