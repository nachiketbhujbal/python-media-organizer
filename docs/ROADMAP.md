...
| 0.6.4 | Stable migration report artifact | Define and export a versioned machine-readable report from the same typed outcome model as the human synopsis, with deterministic path-private output and explicit compatibility rules. | Release candidate |
