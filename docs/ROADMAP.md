...
| 0.5.7 | Plural architecture-decision directory | Rename `docs/adr/` to `docs/adrs/`, retain every numbered decision record unchanged, and update all tracked links plus current path references without changing runtime or package behavior. | In review; hosted checks blocked by the account allowance |
