...
| GUIDE-R07 | Medium | The first v0.6.1 candidate marked the release as complete before merge, exact-main CI, and tag evidence existed. | 0.6.1 | Resolved after independent review by keeping the roadmap and changelog at release-candidate/unreleased state until the release boundary is proven |
